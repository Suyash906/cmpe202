public class Burger extends LeafDecorator
{
    ...
    public void setOptions( String[] options )
    {
        ...
        {
            if ( "1/3lb.".equals(options[i]) ) this.price += 9 ;
            ...
            if ( "Organic Bison*".equals(options[i]) ) this.price += 4 ;
            if ( "Ahi Tuna".equals(options[i]) ) this.price += 4 ;
            if ( "1/2lb.".equals(options[i]) ) this.price += 12 ;
        }
    }
